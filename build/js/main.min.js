...
/* harmony import */ var _modules_smooth_scroll_smooth_scroll__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/smooth-scroll/smooth-scroll */ "./js/modules/smooth-scroll/smooth-scroll.js");
/* harmony import */ var _modules_tabs_tabs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/tabs/tabs */ "./js/modules/tabs/tabs.js");
/* harmony import */ var _modules_slide_slide__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/slide/slide */ "./js/modules/slide/slide.js");
/* harmony import */ var _modules_slide_slide__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_slide_slide__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _modules_tabindex_tabindex__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/tabindex/tabindex */ "./js/modules/tabindex/tabindex.js");
...
var DATA_CONTAINER = DATA.DATA_CONTAINER,
  VIDEO_URL = DATA.VIDEO_URL,
  SCROLL_ATRR = DATA.SCROLL_ATRR,
  DATA_TABS = DATA.DATA_TABS,
  TABS_CLASS = DATA.TABS_CLASS,
  DATA_TABS_LINK = DATA.DATA_TABS_LINK,
  DATA_TABS_CONTENT = DATA.DATA_TABS_CONTENT,
  ACTIVE = DATA.ACTIVE,
  OPEN = DATA.OPEN,
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_smooth_scroll_smooth_scroll__WEBPACK_IMPORTED_MODULE_3__["twistUp"])(SCROLL_ATRR);
  Object(_modules_video_video__WEBPACK_IMPORTED_MODULE_2__["createVideo"])(DATA_CONTAINER, VIDEO_URL);
  Object(_modules_tabs_tabs__WEBPACK_IMPORTED_MODULE_4__["changeTabs"])(DATA_TABS, DATA_TABS_LINK, TABS_CLASS, DATA_TABS_CONTENT, ACTIVE, OPEN);
  Object(_modules_tabindex_tabindex__WEBPACK_IMPORTED_MODULE_6__["removeTabIndex"])(DUPLICATE);
...
var swiperIgnored = new Swiper('.trainer__wrapper', {
...
var reviewsIgnored = new Swiper('.reviews__wrapper', {
  direction: 'horizontal',
  loop: false,
  allowTouchMove: true,
  autoHeight: true,
...
/*!***************************************************!*\
  !*** ./js/modules/smooth-scroll/smooth-scroll.js ***!
  \***************************************************/
/*! exports provided: twistUp */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "twistUp", function() { return twistUp; });
...
var twistUp = function twistUp(atrr) {
  var buttonsScroll = document.querySelectorAll(atrr);
...
/*!*****************************************!*\
  !*** ./js/modules/tabindex/tabindex.js ***!
  \*****************************************/
/*! exports provided: removeTabIndex */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "removeTabIndex", function() { return removeTabIndex; });
var removeTabIndex = function removeTabIndex(items) {
  ...
  if (regex.test(items)) {
    ...
    document.querySelectorAll(items.replace('', '.')).forEach(function (item) {
      return item.removeAttribute('tabindex');
    });
  }
};
...
var changeTabs = function changeTabs(headerAtrr, tabsAtrr, tabsClass, contentSelector, activeClass, openClass) {
  var header = document.querySelector(headerAtrr);
  var tabs = document.querySelectorAll(tabsAtrr);
  var contents = document.querySelectorAll(contentSelector);
  var closestTabsContent = function closestTabsContent() {
  ...
  var showTabsContent = function showTabsContent(element) {
  ...
  var onClickTabs = function onClickTabs(e) {
    e.preventDefault();
    var target = e.target;
...
/*!***********************************!*\
  !*** ./js/modules/video/video.js ***!
  \***********************************/
/*! exports provided: createVideo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createVideo", function() { return createVideo; });
var createVideo = function createVideo(container, link) {
  var video = document.querySelector(container);
  var onClickPlayVideo = function onClickPlayVideo() {
    video.innerHTML = '';
    var iframe = "<iframe class=\"video__link\" width=\"364\" height=\"228\" src=\"".concat(link, "\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>");
